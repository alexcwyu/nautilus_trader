...
# -- QUERIES --------------------------------------------------------------------------------------
    ...
    cpdef dict net_exposures(self, Venue venue=None, AccountId account_id=None, Currency target_currency=None):
        ...
        cdef dict[Currency, double] net_exposures = {}
        cdef:
            Position position
            Money exposure
    ...
    cpdef Money realized_pnl(self, InstrumentId instrument_id, AccountId account_id=None, Currency target_currency=None):
        ...
        if account_id is not None:
            ...
            return self._calculate_realized_pnl(instrument_id, account_id, target_currency=target_currency)
        else:
    ...
    cpdef Money unrealized_pnl(self, InstrumentId instrument_id, Price price=None, AccountId account_id=None, Currency target_currency=None):
        ...
        if price is not None or account_id is not None:
            ...
            return self._calculate_unrealized_pnl(instrument_id, price, account_id, target_currency=target_currency)
        else:
            # Aggregate across all accounts using cache where possible
...
# -- INTERNAL -------------------------------------------------------------------------------------
    ...
    cdef Money _aggregate_pnl_from_cache(self, InstrumentId instrument_id, bint is_realized, Currency target_currency=None):
        ...
        if cache_empty:
            if is_realized:
                ...
                return self._aggregate_pnl_by_calculation(instrument_id, price=None, is_realized=True, target_currency=target_currency)
            else:
                # For unrealized PnL, calculate with current price
                return self._aggregate_pnl_by_calculation(instrument_id, price=None, is_realized=False, target_currency=target_currency)
    ...
    cdef Money _aggregate_pnl_by_calculation(self, InstrumentId instrument_id, Price price, bint is_realized, Currency target_currency=None):
        ...
        for account_id in account_ids:
            if is_realized:
                account_pnl = self._calculate_realized_pnl(instrument_id, account_id, target_currency=target_currency)
            else:
                account_pnl = self._calculate_unrealized_pnl(instrument_id, price, account_id, target_currency=target_currency)
    ...
    cdef Money _calculate_realized_pnl(self, InstrumentId instrument_id, AccountId account_id, Currency target_currency=None):
        ...
        return self._convert_money_if_needed(result, target_currency, venue=instrument_id.venue)
    ...
    cdef Money _calculate_unrealized_pnl(self, InstrumentId instrument_id, Price price=None, AccountId account_id=None, Currency target_currency=None):
