...
cdef class Portfolio(PortfolioFacade):
    ...
    cdef Money _calculate_realized_pnl(self, InstrumentId instrument_id, AccountId account_id, Currency target_currency=*)
    ...
    cdef Money _calculate_unrealized_pnl(self, InstrumentId instrument_id, Price price=*, AccountId account_id=*, Currency target_currency=*)
