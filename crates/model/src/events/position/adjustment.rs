// -------------------------------------------------------------------------------------------------
//  Copyright (C) 2025-2025 Nautech Systems Pty Ltd. All rights reserved.
...
impl PositionAdjustment {
    /// Creates a new [`PositionAdjustment`] instance.
...
mod tests {
    ...
    fn create_test_commission_adjustment() -> PositionAdjustment {
        PositionAdjustment::new(
            ...
            Some(-0.001), // 0.001 BTC commission
            None,
    ...
    fn create_test_funding_adjustment() -> PositionAdjustment {
        PositionAdjustment::new(
            TraderId::from("TRADER-001"),
            StrategyId::from("EMA-CROSS"),
    ...
    fn test_position_adjustment_funding_new() {
        ...
        assert_eq!(adjustment.account_id, AccountId::from("BINANCE-001"));
        assert_eq!(adjustment.adjustment_type, AdjustmentType::Funding);
    ...
    fn test_position_adjustment_debug() {
        ...
        assert!(debug_str.contains("PositionAdjustment"));
    ...
    fn test_position_adjustment_partial_eq() {
        ...
        adjustment3.quantity_change = Some(-0.002);
    ...
    fn test_position_adjustment_different_types() {
        ...
        assert_eq!(commission.adjustment_type, AdjustmentType::Commission);
        assert_eq!(funding.adjustment_type, AdjustmentType::Funding);
    ...
    fn test_position_adjustment_serialization() {
        ...
        let deserialized: PositionAdjustment = serde_json::from_str(&json).unwrap();
