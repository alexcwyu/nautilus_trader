...
impl PositionAdjustment {
    ...
    fn py_adjustment_type(&self) -> AdjustmentType {
        self.adjustment_type
    }

    #[getter]
    #[pyo3(name = "quantity_change")]
    fn py_quantity_change(&self) -> Option<f64> {
    ...
    /// Constructs a [`PositionAdjustment`] from a Python dict.
    ///
    /// # Errors
    ///
    ...
    /// Converts this [`PositionAdjustment`] into a Python dict.
    ///
    /// # Errors
    ///
    ...
    pub fn py_to_dict(&self, py: Python<'_>) -> PyResult<Py<PyAny>> {
        ...
        dict.set_item("type", stringify!(PositionAdjustment))?;
        ...
        match self.quantity_change {
            Some(quantity_change) => dict.set_item("quantity_change", quantity_change)?,
