...
//! Integration tests for Architect WebSocket clients using a mock server.
...
use nautilus_architect::{
    common::enums::{
        ArchitectCandleWidth, ArchitectMarketDataLevel, ArchitectOrderSide, ArchitectTimeInForce,
    },
    websocket::{data::ArchitectMdWebSocketClient, orders::ArchitectOrdersWebSocketClient},
};
...
fn create_test_instrument(symbol: &str) -> InstrumentAny {
    let instrument = CryptoPerpetual::new(
        InstrumentId::new(Symbol::new(symbol), Venue::new("ARCHITECT")),
        Symbol::new(symbol),
        Currency::USD(),
        Currency::USD(),
        Currency::USD(),
...
async fn test_md_client_connection() {
    ...
    let mut client = ArchitectMdWebSocketClient::new(ws_url, "test_token".to_string(), Some(30));
...
async fn test_md_client_url_accessor() {
    ...
    let client = ArchitectMdWebSocketClient::new(ws_url.clone(), "test_token".to_string(), None);
...
async fn test_md_client_not_active_before_connect() {
    let client = ArchitectMdWebSocketClient::new(
...
async fn test_md_close_sets_closed_flag() {
    ...
    let mut client = ArchitectMdWebSocketClient::new(ws_url, "test_token".to_string(), None);
...
async fn test_md_subscribe_l1() {
    ...
    client
        .subscribe("BTCUSD-PERP", ArchitectMarketDataLevel::Level1)
        .await
        .unwrap();
...
async fn test_md_subscribe_l2() {
    ...
    client
        .subscribe("BTCUSD-PERP", ArchitectMarketDataLevel::Level2)
        .await
        .unwrap();
...
async fn test_md_subscribe_l3() {
    ...
    client
        .subscribe("BTCUSD-PERP", ArchitectMarketDataLevel::Level3)
        .await
        .unwrap();
...
async fn test_md_subscribe_multiple_symbols() {
    ...
    client
        ...
        .unwrap();
    client
        .subscribe("ETHUSD-PERP", ArchitectMarketDataLevel::Level2)
        .await
        .unwrap();
    client
        .subscribe("EURUSD-PERP", ArchitectMarketDataLevel::Level1)
        .await
        .unwrap();
...
async fn test_md_subscribe_candles() {
    ...
    client
        .subscribe_candles("BTCUSD-PERP", ArchitectCandleWidth::Minutes1)
        .await
        .unwrap();
...
async fn test_md_unsubscribe_candles() {
    ...
    client
        .unsubscribe_candles("BTCUSD-PERP", ArchitectCandleWidth::Minutes1)
        .await
        .unwrap();
...
async fn test_md_reconnection_after_disconnect() {
    ...
    let mut client =
        ArchitectMdWebSocketClient::new(ws_url.clone(), "test_token".to_string(), None);
    ...
    let mut client2 = ArchitectMdWebSocketClient::new(ws_url, "test_token".to_string(), None);
...
async fn test_orders_client_connection() {
    ...
    let account_id = AccountId::from("ARCHITECT-001");

    let mut client = ArchitectOrdersWebSocketClient::new(ws_url, account_id, Some(30));
...
async fn test_orders_client_url_accessor() {
    ...
    let account_id = AccountId::from("ARCHITECT-001");
    let client = ArchitectOrdersWebSocketClient::new(ws_url.clone(), account_id, None);
...
async fn test_orders_client_account_id_accessor() {
    let ws_url = "ws://localhost:9999/orders/ws".to_string();
    let account_id = AccountId::from("ARCHITECT-001");
    let client = ArchitectOrdersWebSocketClient::new(ws_url, account_id, None);
...
async fn test_orders_client_not_active_before_connect() {
    let account_id = AccountId::from("ARCHITECT-001");
    let client = ArchitectOrdersWebSocketClient::new(
...
async fn test_orders_close_sets_closed_flag() {
    ...
    let mut client = ArchitectOrdersWebSocketClient::new(ws_url, account_id, None);
...
async fn test_md_subscription_failure_tracking() {
    ...
    client
        .subscribe("FAIL-SYMBOL", ArchitectMarketDataLevel::Level1)
        .await
        .unwrap();
...
async fn test_multiple_md_clients() {
    ...
    let mut client1 = ArchitectMdWebSocketClient::new(ws_url.clone(), "token1".to_string(), None);
    let mut client2 = ArchitectMdWebSocketClient::new(ws_url, "token2".to_string(), None);
...
async fn test_md_client_debug() {
    ...
    assert!(debug_str.contains("ArchitectMdWebSocketClient"));
...
async fn test_orders_client_debug() {
    ...
    let debug_str = format!("{client:?}");
    assert!(debug_str.contains("ArchitectOrdersWebSocketClient"));
